...
ua = UserAgent()
f = open('第二次.csv', mode='a', encoding='utf-8', newline='')
csv_writer = csv.DictWriter(f, fieldnames=['title','Kingdom', 'Phylum','Class','Subclass','Order','Family','Genus','Species','Variety','原始链接'])
csv_writer.writeheader()
f2 = open('aeepted2.csv', mode='a', encoding='utf-8', newline='')
csv_writer2 = csv.DictWriter(f2, fieldnames=['title','name', 'link' ])
csv_writer2.writeheader()
f3 = open('Synonyms2.csv', mode='a', encoding='utf-8', newline='')
csv_writer3= csv.DictWriter(f3, fieldnames=['title','name','link' ])
csv_writer3.writeheader()
f4 = open('native2.csv', mode='a', encoding='utf-8', newline='')
...
f6 = open('缺失2.csv', mode='a', encoding='utf-8', newline='')
